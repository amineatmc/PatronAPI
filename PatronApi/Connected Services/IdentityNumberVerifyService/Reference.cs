...
namespace IdentityNumberVerifyService
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="IdentityNumberVerifyService.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        System.Threading.Tasks.Task<IdentityNumberVerifyService.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(IdentityNumberVerifyService.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public IdentityNumberVerifyService.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(IdentityNumberVerifyService.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public IdentityNumberVerifyService.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(IdentityNumberVerifyService.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface KPSPublicSoapChannel : IdentityNumberVerifyService.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<IdentityNumberVerifyService.KPSPublicSoap>, IdentityNumberVerifyService.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<IdentityNumberVerifyService.TCKimlikNoDogrulaResponse> IdentityNumberVerifyService.KPSPublicSoap.TCKimlikNoDogrulaAsync(IdentityNumberVerifyService.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<IdentityNumberVerifyService.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            IdentityNumberVerifyService.TCKimlikNoDogrulaRequest inValue = new IdentityNumberVerifyService.TCKimlikNoDogrulaRequest();
            inValue.Body = new IdentityNumberVerifyService.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((IdentityNumberVerifyService.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
